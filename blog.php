...
<head>
  ...
  <title>East West University Staff Management - Blog</title>
...
<body>
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="blog.php" class="active">হেল্পলাইন</a></li>
  ...
  <main id="main">
    ...
    <div class="news-wrap">
            <h1 style="text-align: center; font-weight: bold; background: linear-gradient(180deg, #e11414, #0a5aef); color: #ffffff;">Call: +02754603</h1>
