...
<head>
  ...
  <title>East West University Staff Management - Contact</title>
    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4">
          <div class="col-lg-6">
            <div class="info-item  d-flex flex-column justify-content-center align-items-center">
              <i class="bi bi-map"></i>
              <h3>ঠিকানা</h3>
              <p>Jahurul Islam City Gate, A/2 Jahurul Islam Ave, Dhaka 1212</p>
            </div>
          </div><!-- End Info Item -->
        ...
        <div class="row gy-4 mt-1">
          ...
          <div class="col-lg-6 ">
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d9069.263882780213!2d90.4255046!3d23.77002912092792!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x853ad729be4edc71!2sEast%20West%20University!5e0!3m2!1sen!2sbd!4v1671818536910!5m2!1sen!2sbd" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          </div><!-- End Google Maps -->
          ...
          <div class="col-lg-6">
            <form action="forms/contact.php" method="post" role="form" class="php-email-form">
              ...
              <div class="form-group">
                <input type="text" class="form-control" name="subject" id="subject" placeholder="সাবজেক্ট" required>
              </div>
              <div class="form-group">
                <textarea class="form-control" name="message" rows="5" placeholder="ম্যাসেজ" required></textarea>
              </div>
              <div class="my-3">
              ...
              <div class="text-center"><button type="submit">ম্যাসেজ পাঠান </button></div>
            </form>
